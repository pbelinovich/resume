...
import { Box, Container, Stack, Heading, Text, Badge, Card, Flex, Separator, VStack, Grid, List, Link } from '@chakra-ui/react'
...
export const RecifraPDF: React.FC = () => (
  <Box bg="bg">
    <Container>
      <RecifraContent />
    </Container>
